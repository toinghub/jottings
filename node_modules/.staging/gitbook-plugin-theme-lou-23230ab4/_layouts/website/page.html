{% extends template.self %} {% block body %} {% if book.themeLou.footer.donate
%}
<div class="donate-modal modal">
    ...
    <div>
      <span>
        <img
          id="modal-avatar"
          class="modal-avatar"
          src="{{book.themeLou.footer.donate.avatar}}"
        />
      </span>
      <span id="nickname"> {{book.themeLou.footer.donate.nickname}} </span>
      <p class="modal-close close" onclick="closeDonateModal()">×</p>
    </div>
    <div class="message">
      <div class="tip">
        <i></i>
        <span>{{ book.themeLou.footer.donate.message }}</span>
      </div>
    </div>
  </div>
  <div class="modal-content">
    ...
    <div class="modal-pay-qrcode">
      <img id="wxpay-code" src="{{ book.themeLou.footer.donate.wxpay }}" />
      <img
        id="alipay-code"
        src="{{ book.themeLou.footer.donate.alipay }}"
        hidden
      />
    </div>
  </div>
    ...
    <div class="body-inner">
      ...
      <div class="page-wrapper" tabindex="-1" role="main">
        <div class="page-inner">
          ...
          {% endblock %} {% if book.themeLou.footer %}
          <div class="book-footer">
            {% if book.themeLou.footer.donate %}
            <div class="donate">
              <div>{{ book.themeLou.footer.donate.text }}</div>
              <button class="donate-btn" onclick="showModal()">赞赏</button>
            </div>
            {% endif %} {% if book.themeLou.footer.copyright %}
